...
const defaultFilteredData = data.filter((item) => item.street === 'Broadway');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'Broadway';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.thomasSt}>Broadway</b>
            <img
