...
const defaultFilteredData = data.filter((item) => item.street === 'Abercrombie St');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'Abercrombie St';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.ASt}>Abercrombie St</b>
            <img
