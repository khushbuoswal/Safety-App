...
const Statistics: FunctionComponent<StatisticsType> = ({ onClose }) => {
  ...
  const [defaultMessage, setDefaultMessage] = useState<string>("Select a date to compare data");
...
const defaultFilteredData = data.filter((item) => item.street === 'Mountain St');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'Mountain St';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.thomasSt}>Mountain St</b>
            <img
