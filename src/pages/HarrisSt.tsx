...
const defaultFilteredData = data.filter((item) => item.street === 'Harris St');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'Harris St';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.thomasSt}>Harris St</b>
            <img
