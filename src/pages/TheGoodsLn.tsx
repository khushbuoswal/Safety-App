...
const defaultFilteredData = data.filter((item) => item.street === 'TheGoodsLn');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'TheGoodsLn';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.thomasSt}>TheGoodsLn</b>
            <img
