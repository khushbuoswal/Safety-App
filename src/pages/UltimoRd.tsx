...
const defaultFilteredData = data.filter((item) => item.street === 'Ultimo Rd');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'Ultimo Rd';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.thomasSt}>Ultimo Rd</b>
            <img
