...
const defaultFilteredData = data.filter((item) => item.street === 'Jones St');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'Jones St';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.thomasSt}>Jones St</b>
            <img
