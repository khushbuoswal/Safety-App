...
const defaultFilteredData = data.filter((item) => item.street === 'Queen St');
...
? data.filter((item) => {
    ...
    return itemDate === selectedDate && item.street === 'Queen St';
  })
  : defaultFilteredData;
      ...
      <>
        <div className={styles.statistics}>
          ...
          <div className={styles.headerReportincidents}>
            ...
            <b className={styles.thomasSt}>Queen St</b>
            <img
